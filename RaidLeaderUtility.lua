...
function RLU:SetupCombatLogging()
    ...
    if not CombatLoggingButton then
        ...
        CombatLoggingButton:SetPoint("TOP", UIParent, "TOP", -101, -1)
...
local function CreateRaidInfoFrame()
    ...
    function UpdateGrid()
        ...
        for j = 1, numUnits do
            ...
            local isFullyBuffed = hasFood and hasFlask and hasRune
            ...
            if isFullyBuffed then
                unitFrame:SetBackdropColor(100 / 255, 255 / 255, 100 / 255, 0.5)
            end

            if hasVantus then
                unitFrame:SetBackdropBorderColor(255 / 255, 255 / 255, 255 / 255, 1.0)
            end

            if hasSOM then
                unitFrame:SetBackdropBorderColor(64 / 255, 255 / 255, 255 / 255, 1.0)
            end

            if hasSoulstone then
                unitFrame:SetBackdropBorderColor(128 / 255, 64 / 255, 255 / 255, 1.0)
            end
            ...
            unitText:SetText(j .. ". " .. RLU:ClassColourName(unitName))
            ...
            unitFrame:SetScript("OnEnter", function(self)
                ...
                GameTooltip:AddLine("|cFFFFFFFFVantus|r: " .. vantusType)
...
function RLU:SetupPullTimer()
    if not PullTimerButton then
        ...
        PullTimerButton:SetPoint("TOP", UIParent, "TOP", 101, -1)
